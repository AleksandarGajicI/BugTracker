...
namespace BugTracker.Migrations
{
    ...
    [Migration("20210412195424_added-comments")]
            ...
            modelBuilder.Entity("BugTracker.model.Comment", b =>
                {
                    ...
                    b.Property<Guid?>("CommenterProjectId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("CommenterUserAssignedId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CommenterUserAssignedId", "CommenterProjectId");
            ...
            modelBuilder.Entity("BugTracker.model.Comment", b =>
                {
                    ...
                    b.HasOne("BugTracker.model.ProjectUserReq", "Commenter")
                        .WithMany()
                        .HasForeignKey("CommenterUserAssignedId", "CommenterProjectId");
